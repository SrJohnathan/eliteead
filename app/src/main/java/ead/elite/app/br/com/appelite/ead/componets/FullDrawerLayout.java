...
public class FullDrawerLayout extends DrawerLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (isContentView(child)) {
                ...
                throw new IllegalStateException("View " + child + " inicio " + i +
                        " aumentar tamanho da view, " +
                        "Gravirt View");
            }
        }
    }
    ...
    boolean isDrawerView(View child) {
        ...
        final int absGravity = Gravity.getAbsoluteGravity(gravity,
                child.LAYOUT_DIRECTION_RTL);
        return (absGravity & (Gravity.LEFT | Gravity.RIGHT)) != 0;
    }

    int getDrawerViewGravity(View drawerView) {
        final int gravity = ((LayoutParams) drawerView.getLayoutParams()).gravity;
        return Gravity.getAbsoluteGravity(gravity, drawerView.LAYOUT_DIRECTION_RTL);
    }
