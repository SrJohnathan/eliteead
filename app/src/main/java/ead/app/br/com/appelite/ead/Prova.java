package ead.app.br.com.appelite.ead;
...
import ead.app.br.com.appelite.ead.dominio.ProgressText;
...
import ead.app.br.com.appelite.ead.services.PrograssService;
...
public class Prova extends AppCompatActivity implements OnClickItemProva {
    ...
    private ArrayList<ead.app.br.com.appelite.ead.dominio.Prova> provas;
                    ...
                    if (jsonObject.has("0")) {
                        ...
                        for (int i = 0; i < jsonObject.length(); i++) {
                            try {
                                ...
                                ead.app.br.com.appelite.ead.dominio.Prova prova = new ead.app.br.com.appelite.ead.dominio.Prova(id, questao, pergunta, rp1, rp2, rp3, rp4, "certa", idcurso, iduser, 0);
                                provas.add(prova);
    ...
    protected void onStart() {
        ...
        if(prova){
            ...
            startService(new Intent(Prova.this, PrograssService.class));
        }
