...
import ead.app.br.com.appelite.ead.dominio.Curso;
...
import ead.app.br.com.appelite.ead.util.IabHelper;
import ead.app.br.com.appelite.ead.util.IabResult;
import ead.app.br.com.appelite.ead.util.Purchase;
...
public class CompraPag extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Curso strtext = getArguments().getParcelable("put");

        ((AtividadeTabs)getActivity()).isfragment(true);
                            ...
                            btnCallPayment.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if (estado == true) {
                                        ...
                                        Snackbar.make(btnCallPayment, "Login Necessário", Snackbar.LENGTH_SHORT).setCallback(new Snackbar.Callback() {
                                            @Override
                                            public void onDismissed(Snackbar snackbar, int event) {
                                                super.onDismissed(snackbar, event);
                                                ((AtividadeTabs)getActivity()).loginApp();
                                            }
                                        }).show();
                                    }
            ...
            btnCallPayment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (estado == true) {
                        ...
                        Snackbar.make(rootView, "Login Necessário", Snackbar.LENGTH_SHORT).setCallback(new Snackbar.Callback() {
                            @Override
                            public void onDismissed(Snackbar snackbar, int event) {
                                super.onDismissed(snackbar, event);
                                ((AtividadeTabs)getActivity()).loginApp();
...
menufab.hide();
    ...
    public void onStop() {
        super.onStop();
        ((AtividadeTabs)getActivity()).isfragment(false);
        menufab.show();
